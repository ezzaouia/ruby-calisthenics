...
describe 'palindrome detection' do
  ...
  it 'should ignore nonword characters [10 points]' do
    ...
    'Evil I did dwell; lewd did I live.'.should be_a_palindrome
  end

  it 'my tests 1 --- should ignore nonword characters [10 points]' do
    'Evil I did dwell; lewd did I live.'.should be_a_palindrome
  end
  it 'my tests 2 --- should ignore nonword characters [10 points]' do
    'Go droop-stop-onward draw no pots poor dog'.should be_a_palindrome
  end
  it 'my tests 2 --- should ignore nonword characters [10 points]' do
    'Niagara, O roar again!'.should be_a_palindrome
  end
...
describe 'word count' do
  ...
  it ' test 1--  works on simple strings [10 points]' do
    'Doo bee; doo bee doo?'.count_words.should ==
      {'doo' => 3, 'bee' => 2}
  end
...
describe 'anagram grouping' do
  ...
  it 'mt test -- for "scream cars for four scar creams" [10 points]' do
    @anagrams =  "rats tars Star".anagram_groups
   # debugger
    @anagrams.each { |group| group.sort! }
    [%w(Star rats tars)].each do |group|
                @anagrams.should include(group)
    end
  end
